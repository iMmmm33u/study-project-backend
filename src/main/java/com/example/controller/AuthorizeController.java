...
public class AuthorizeController {
    ...
    public RestBean<String> validateRegisterEmail(@Pattern(regexp = EMAIL_REGEX)  @RequestParam(value = "email") String email,
                                          HttpSession session) {
    ...
    public RestBean<String> validateResetEmail(@Pattern(regexp = EMAIL_REGEX)  @RequestParam(value = "email") String email,
                                          HttpSession session) {
